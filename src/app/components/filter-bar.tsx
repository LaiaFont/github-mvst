export const FilterBar = ({ setNameValue, setLanguageValue, languages }: {setNameValue: any, setLanguageValue: any, languages: any}) => (
    <div className="flex flex-row relative mt-2 rounded-md shadow-sm">
        ...
        />
        <select className="block w-1/4 rounded-md border-0 mx-1 py-1.5 px-2 text-gray-900 ring-1 ring-inset ring-gray-300 sm:text-sm sm:leading-6 focus:bg-gray-200" onChange={(e) => setLanguageValue(e.target.value)}>
